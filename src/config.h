...
#define PACKAGE_BUGREPORT "https://github.com/rocky/remake/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "remake"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "remake 4.3+dbg-1.6"
...
#define PACKAGE_VERSION "4.3+dbg-1.6"

/* Define to the character that separates directories in PATH. */
#define PATH_SEPARATOR_CHAR ':'

/* Minimum profiler resolution in nanoseconds */
#define PROFILER_MIN_RES 1000
...
#define REMAKE_SOURCE_PATH "/src/external-vcs/github/rocky/remake"
